...
def test():
    ...
    ''' test exceed column '''
    #db.insert_image("./vitess_test/imageVideo_test_checkExceedColumn.csv", "./vitess_test/imageFeature_test_standard.csv")
    
    ''' test missing column '''
    #db.insert_image("./vitess_test/imageVideo_test_checkMissingColumn.csv", "./vitess_test/imageFeature_test_standard.csv")

    ''' test missing values '''
    #db.insert_image("./vitess_test/imageVideo_test_checkMissingValues.csv", "./vitess_test/imageFeature_test_standard.csv")

    ''' test empty cell -- FAIL !!!!!!!!!! '''
    #db.insert_image("./vitess_test/imageVideo_test_checkEmptyCell.csv", "./vitess_test/imageFeature_test_standard.csv")

    ''' test add same things twice '''
    #db.insert_image("./vitess_test/imageVideo_test_checkInsertExistValue.csv", "./vitess_test/imageFeature_test_standard.csv")
    ...
    #db.insert_image("./vitess_test/imageVideo_test_standard.csv", "./vitess_test/imageFeature_test_checkHeader.csv")
    
    ''' 15. test exceed column '''
    #db.insert_image("./vitess_test/imageVideo_test_standard.csv", "./vitess_test/imageFeature_test_checkExceedColumn.csv")

    ''' 16. test missing column '''
    #db.insert_image("./vitess_test/imageVideo_test_standard.csv", "./vitess_test/imageFeature_test_checkMissingColumn.csv")

    ''' 17. test missing values '''
    #db.insert_image("./vitess_test/imageVideo_test_standard.csv", "./vitess_test/imageFeature_test_checkMissingValues.csv")

    ''' 18. test empty cell '''
    #db.insert_image("./vitess_test/imageVideo_test_standard.csv", "./vitess_test/imageFeature_test_checkEmptyCell.csv")

    ''' 19. test add same things twice '''
    #db.insert_image("./vitess_test/imageVideo_test_standard.csv", "./vitess_test/imageFeature_test_checkInsertExistValue.csv")
    ...
    ''' test wrong hearder name '''
    #db.insert_image("./vitess_test/imageVideo_test_checkHeader.csv", "./vitess_test/imageFeature_test_checkHeader.csv")
