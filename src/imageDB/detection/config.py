...
__C.YOLO.ORIGINAL_WEIGHT        = "./detection/checkpoint/yolov3_coco.ckpt"
__C.YOLO.DEMO_WEIGHT            = "./detection/checkpoint/yolov3_coco_demo.ckpt"

# Train options
__C.TRAIN                       = edict()

__C.TRAIN.ANNOT_PATH            = "./detection/data/dataset/voc_train.txt"
...
__C.TRAIN.INITIAL_WEIGHT        = "./detection/checkpoint/yolov3_coco_demo.ckpt"
...
__C.TEST.ANNOT_PATH             = "./detection/data/dataset/voc_test.txt"
